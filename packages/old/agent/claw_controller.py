...
class ClawState(BaseModel):
    ...
    # is 3200 steps per the V2_agent firmware (200 steps * 16 microsteps).
    x: int = 0
    y: int = 0
    z: int = 0
...
class ClawController:
    ...
    # Steps per revolution — matches firmware STEPS_PER_REVOLUTION
    STEPS_PER_REV = 3200
    ...
    def _handle_line(self, line: str) -> None:
        ...
        if head == "STATE":
            # STATE <id> <fsm_state> X=.. Y=.. Z=.. LX=.. LA=.. LZ=.. SERVO=.. EN=..
